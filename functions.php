...
function tranquil_scripts() {
    ...
    // if statement for comment reply box directly under each reply and nested replies
    if( is_singular() 
        && comments_open()
...
function featureText() {
    if( is_front_page() ) {
        // ACF IMPLEMENTED TO EDIT HEADER TEXT FROM DASHBOARD USING the_field FUNCTION
        the_field('header_text_front_page');
        // is_home is the blog home index page
        ...
        _e("Whoops, were a little lost <br> <em>Let's get back on track</em>");
    }
     else {
...
register_default_headers( array(
    'lake1' => array(
        'uri' => get_template_directory_uri() . '/images/lake.jpg',
        'thumbnail_url' => get_template_directory_uri() . '/images/lake.jpg',
        'description' => __(' Lake 1 ')
    ),
    'lake2' => array(
        'uri' => get_template_directory_uri() . '/images/lake2.jpg',
